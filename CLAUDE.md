...
## Recent Changes
- 002-multi-league-platform: Added TypeScript 5.x (existing codebase) + Next.js 14 (App Router), TanStack Query v5, Prisma 5 (SQLite), Tailwind CSS, Zod — all already installed.
